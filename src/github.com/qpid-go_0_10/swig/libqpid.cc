...
QpidConnection::QpidConnection(const std::string &url, const std::string options) {
//	try {
		pConnection = new Connection(url, options);
/*
...
void QpidConnection::Open() {
		pConnection->open();
}

/*
void QpidConnection::CreateSession() {
		Session *pSession = 
		return pConnection->createSession();
}
*/
...
//
//
//void qpid_session_ack(qpid_session_t s, bool sync) {
//	Session *pSession = (Session *)s;
//	pSession->acknowledge(sync);
//}
//
//void qpid_session_ack_message(qpid_session_t s, qpid_msg_t msg, bool sync) {
//	Session *pSession = (Session *)s;
...
//}
//
//void qpid_msg_set_duarable(qpid_msg_t m, bool durable){
//	Message *pMsg = (Message*)m;
